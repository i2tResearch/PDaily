package co.icesi.pdaily.clinical.base.levodopa;
...
import co.icesi.pdaily.clinical.base.levodopa.type.LevodopaTypeTesting;
...
public class LevodopaMedicineResourceIT implements IDataSetDependent {
    ...
    void saveLevodopaMedicine() {
        final var dto = LevodopaMedicineDTO.of( null, TestNamesGenerator.generateName(),
    ...
    void failsToSaveIfDuplicatedName() {
        final var dto = LevodopaMedicineDTO.of( null, "EXISTENT",
                LevodopaTypeTesting.LEVODOPA_TYPE_ID, 210 );
        given().contentType( MediaType.APPLICATION_JSON )
                .body( dto )
                .post( "/medicine/levodopa" )
    ...
    void updatesLevodopaMedicine() {
        final var dto = LevodopaMedicineDTO.of( LevodopaMedicineTesting.LEVODOPA_MEDICINE_TO_UPDATE,
    ...
    void failsIfDuplicatedNameOnExistent() {
        final var dto = LevodopaMedicineDTO.of( LevodopaMedicineTesting.LEVODOPA_MEDICINE_TO_UPDATE, " existent ",
                LevodopaTypeTesting.LEVODOPA_TYPE_ID, 210);
        given().contentType( MediaType.APPLICATION_JSON )
                .body( dto )
                .post( "/medicine/levodopa" )
