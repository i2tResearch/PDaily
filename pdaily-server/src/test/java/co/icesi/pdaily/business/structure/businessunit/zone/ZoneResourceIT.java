...
class ZoneResourceIT implements IDataSetDependent {
	...
	public List<IDataSet> dataSets() {
		return List.of( DataSets.ZONE, DataSets.CUSTOMER_BUSINESS_VIEW );
	}
	...
	@Test
	@DisplayName("Fails deletion if zone has customers")
	void failsIfDeleteWithCustomers() {
		given().contentType( MediaType.APPLICATION_JSON )
				.delete( "/business/structure/zone/{0}", CustomerTesting.ZONE_FOR_DELETE_VALIDATION )
				.then()
				.statusCode( 400 )
				.body(
