package co.icesi.pdaily.sales.activities.purpose.app;
...
import co.icesi.pdaily.sales.activities.purpose.domain.model.PurposeValidator;
...
public class PurposeAppService {
	...
	public void deletePurpose(String id) {
		repository.delete( PurposeId.ofNotNull( id ) );
	}
