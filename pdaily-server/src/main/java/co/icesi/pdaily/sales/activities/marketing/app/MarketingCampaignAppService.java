package co.icesi.pdaily.sales.activities.marketing.app;
...
import co.icesi.pdaily.sales.activities.marketing.domain.model.MarketingCampaign;
import co.icesi.pdaily.sales.activities.marketing.domain.model.MarketingCampaignId;
import co.icesi.pdaily.sales.activities.marketing.domain.model.MarketingCampaignValidator;
...
public class MarketingCampaignAppService {
	...
	public void deleteMarketingCampaign(String id) {
		repository.delete( MarketingCampaignId.ofNotNull( id ) );
	}
