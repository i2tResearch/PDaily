package co.haruk.sms.business.structure.businessunit.product.domain.model;
...
@NamedQuery(name = Product.findAllAsReadView, query = "SELECT new co.haruk.sms.business.structure.businessunit.product.domain.model.view.ProductReadView(p.id.id, p.name.name, p.reference.text, b.name.name, p.businessUnit.id, r.name.name, p.brandId.id, l.name.name, p.lineId.id, g.name.name, p.groupId.id) "
		+
...
@NamedQuery(name = Product.findByIdAsReadView, query = "SELECT new co.haruk.sms.business.structure.businessunit.product.domain.model.view.ProductReadView(p.id.id, p.name.name, p.reference.text, b.name.name, p.businessUnit.id, r.name.name, p.brandId.id, l.name.name, p.lineId.id, g.name.name, p.groupId.id) "
		+
		"FROM Product p " +
...
@NamedQuery(name = Product.findByBUnitAsReadView, query = "SELECT new co.haruk.sms.business.structure.businessunit.product.domain.model.view.ProductReadView(p.id.id, p.name.name, p.reference.text, b.name.name, p.businessUnit.id, r.name.name, p.brandId.id, l.name.name, p.lineId.id, g.name.name, p.groupId.id) "
		+
